...
/** 确认租赁合同请求 DTO。 */
export class ConfirmContractDto extends createZodDto(confirmContractSchema) {}
/** 取消租赁合同请求 DTO。 */
export class CancelContractDto extends createZodDto(cancelContractSchema) {}
/** 撤销未来合同终止请求 DTO。 */
export class RevokeContractTerminationDto extends createZodDto(revokeContractTerminationSchema) {}
/** 创建续租草稿请求 DTO。 */
export class RenewContractDto extends createZodDto(renewContractSchema) {}
/** 删除合同草稿请求 DTO。 */
export class DeleteContractDto extends createZodDto(deleteContractSchema) {}
